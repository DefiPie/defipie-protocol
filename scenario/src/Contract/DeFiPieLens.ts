...
export interface DeFiPieLensMethods {
  ...
  pTokenMetadata(pToken: string): Sendable<[string,number,number,number,number,number,number,number,number,boolean,number,string,number,number]>;
  pTokenMetadataAll(pTokens: string[]): Sendable<[string,number,number,number,number,number,number,number,number,boolean,number,string,number,number][]>;

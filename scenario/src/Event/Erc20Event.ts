...
import {PTokenErrorReporter} from '../ErrorReporter';
...
async function approve(world: World, from: string, erc20: Erc20, address: string, amount: NumberV): Promise<World> {
  let invokation = await invoke(world, erc20.methods.approve(address, amount.encode()), from, PTokenErrorReporter);
...
async function faucet(world: World, from: string, erc20: Erc20, address: string, amount: NumberV): Promise<World> {
  let invokation = await invoke(world, erc20.methods.allocateTo(address, amount.encode()), from, PTokenErrorReporter);
...
async function transfer(world: World, from: string, erc20: Erc20, address: string, amount: NumberV): Promise<World> {
  let invokation = await invoke(world, erc20.methods.transfer(address, amount.encode()), from, PTokenErrorReporter);
...
async function transferFrom(world: World, from: string, erc20: Erc20, owner: string, spender: string, amount: NumberV): Promise<World> {
  let invokation = await invoke(world, erc20.methods.transferFrom(owner, spender, amount.encode()), from, PTokenErrorReporter);
...
async function setFail(world: World, from: string, erc20: Erc20, fail: boolean): Promise<World> {
  let invokation = await invoke(world, erc20.methods.setFail(fail), from, PTokenErrorReporter);

...
# set PIE address to getPieAddress() in Controller
npx saddle deploy Controller
npx saddle deploy Unitroller
npx saddle deploy WhitePaperInterestRateModel 20000000000000000 1000000000000000000
npx saddle deploy Registry
npx saddle deploy RegistryProxy "$Registry" "$PErc20Delegate"
npx saddle deploy UniswapPriceOracle
npx saddle deploy UniswapPriceOracleProxy "$UniswapPriceOracle" "$Registry" "0x5c69bee701ef814a2b6a3edd4b1652cb9cc5aa6f" "0xc778417e063141139fce010982780140aa0cd5ab" "0x8A753747A1Fa494EC906cE90E9f37563A8AF630e"
npx saddle deploy PTokenFactory "$RegistryProxy" 1000000000000000000 "$UniswapPriceOracleProxy" "$Unitroller" "$WhitePaperInterestRateModel" 20000000000000000

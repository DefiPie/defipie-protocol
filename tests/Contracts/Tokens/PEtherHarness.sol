...
import "../../../contracts/Tokens/PEther.sol";
import "../Control/ControllerScenario.sol";
import "../../../contracts/Tokens/PEtherDelegate.sol";
import "../../../contracts/Tokens/PEtherDelegator.sol";
...
contract PEtherHarness is PEther {
    ...
    function harnessRedeemFresh(address account, uint pTokenAmount, uint underlyingAmount) public returns (uint) {
    ...
    function harnessBorrowFresh(address account, uint borrowAmount) public returns (uint) {
    ...
    function harnessDoTransferOut(address to, uint amount) public payable {

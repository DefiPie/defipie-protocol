...
describe('Controller', () => {
  ...
  beforeEach(async () => {
    ...
    pTokenBorrowed = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, underlyingPrice: 0});
    pTokenCollateral = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, pTokenFactory: pTokenBorrowed.pTokenFactory, underlyingPrice: 0});
  });

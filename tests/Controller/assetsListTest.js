...
describe('assetListTest', () => {
  ...
  beforeEach(async () => {
    ...
    OMG = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, name: 'OMG', symbol: 'OMG', supportMarket: true, underlyingPrice: 0.5});
    ZRX = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, pTokenFactory: OMG.pTokenFactory, name: 'ZRX', symbol: 'ZRX', supportMarket: true, underlyingPrice: 0.5});
    BAT = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, pTokenFactory: OMG.pTokenFactory, name: 'BAT', symbol: 'BAT', supportMarket: true, underlyingPrice: 0.5});
    REP = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, pTokenFactory: OMG.pTokenFactory, name: 'REP', symbol: 'REP', supportMarket: true, underlyingPrice: 0.5});
    DAI = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, pTokenFactory: OMG.pTokenFactory, name: 'DAI', symbol: 'DAI', supportMarket: true, underlyingPrice: 0.5});
    SKT = await makePToken({controller: controller, priceOracle: controller.priceOracle, registryProxy: controller.registryProxy, pTokenFactory: OMG.pTokenFactory, name: 'SKT', symbol: 'SKT', supportMarket: true, underlyingPrice: 0.5});
